...
const modelsDetailDb = {
  ...
  "dall-e-3": {
    ...
    maxOutput: "1 Image",
    cost1kInput: "$0.040 / image",
    cost1kOutput: "N/A",
    description: "OpenAI's state-of-the-art image generator, excellent at text rendering, complex instructions, and prompt adherence.",
    bestFor: "High-fidelity illustrations, text in images, and precise scene composition.",
    releaseDate: "Q3 2023",
    status: "Premium Live"
  },
  "flux-schnell": {
    ...
    contextWindow: "N/A (Image)",
    maxOutput: "1 Image",
    cost1kInput: "$0.003 / image",
    cost1kOutput: "N/A",
    description: "Ultra-fast open-weights image generator, produces highly detailed images in seconds with superb prompt adherence.",
    bestFor: "Real-time generation, detailed digital art, and speedy prototyping.",
    releaseDate: "Q3 2024",
    status: "Premium Live"
  },
  "midjourney-v6": {
    ...
    contextWindow: "N/A (Image)",
    maxOutput: "1 Image",
    cost1kInput: "$0.050 / image",
    cost1kOutput: "N/A",
    description: "Flagship artistic image generator, renowned for cinematic quality, unparalleled photorealism, and artistic aesthetic.",
    bestFor: "Cinematic scenes, photorealistic human assets, and concept art.",
    releaseDate: "Q4 2023",
    status: "Premium Live"
  },
  "stable-diffusion-3.5": {
    ...
    contextWindow: "N/A (Image)",
    maxOutput: "1 Image",
    cost1kInput: "$0.010 / image",
    cost1kOutput: "N/A",
    description: "Highly versatile open image generator, strong at complex layout and anatomical detail.",
    bestFor: "Custom style training, local deployment, and layout control.",
    releaseDate: "Q4 2024",
    status: "Premium Live"
  },
  "sora": {
    ...
    maxOutput: "60 seconds",
    cost1kInput: "$2.00 / video",
    cost1kOutput: "N/A",
    description: "Creates highly realistic and imaginative video scenes from text instructions up to a full minute long.",
    bestFor: "Cinematic B-roll, complex character animations, and advertising clips.",
    releaseDate: "Q1 2025",
    status: "Premium Live"
  },
  "kling-1.5": {
    ...
    cost1kInput: "$0.80 / video",
    cost1kOutput: "N/A",
    description: "High-fidelity video generator, strong physics modeling and motion dynamics for high action realism.",
    bestFor: "Action sequences, character-object interactions, and fluid motion.",
    releaseDate: "Q3 2024",
    status: "Premium Live"
  },
  "runway-gen3": {
    ...
    contextWindow: "N/A (Video)",
    maxOutput: "10 seconds",
    cost1kInput: "$1.00 / video",
    cost1kOutput: "N/A",
    description: "Professional text-to-video generator, exceptional photorealism, precise camera control, and lighting control.",
    bestFor: "Commercial cinematic clips, direct camera transitions, and visual effects.",
    releaseDate: "Q2 2024",
    status: "Premium Live"
  },
  "luma-dream-machine": {
    ...
    contextWindow: "N/A (Video)",
    maxOutput: "5 seconds",
    cost1kInput: "$0.50 / video",
    cost1kOutput: "N/A",
    description: "Rapidly generates high-quality cinematic clips with smooth motion, consistent styling, and coherence.",
    bestFor: "Quick animations, panning camera work, and high-coherence assets.",
    releaseDate: "Q2 2024",
    status: "Premium Live"
  }
};
